<div class="wrap about-wrap full-width-layout qlwrap">
  <div class="has-2-columns is-wider-left" style="max-width: 100%">
    ...
    <div class="column">
      <img src="<?php echo QUADMENU_PLUGIN_URL; ?>assets/backend/images/screenshot.png">
    </div>
  </div>
  <hr/>
  <div class="has-2-columns is-wider-right" style="max-width: 100%">
    <div class="column">
      <img style="box-shadow: 0px 0px 20px 2px rgb(0,0,0,0.05);" src="<?php echo QUADMENU_PLUGIN_URL; ?>assets/backend/images/tabs.jpg">
    </div>
    <div class="column">
      <div class="feature-section" style="margin: 15px 0;">
  ...
  <div class="has-2-columns is-wider-left" style="max-width: 100%">
    ...
    <div class="column">
      <img style="box-shadow: 0px 0px 20px 2px rgb(0,0,0,0.05);" src="<?php echo QUADMENU_PLUGIN_URL; ?>assets/backend/images/carousel.jpg">
    </div>
  </div>
  <hr/>
  <div class="has-2-columns is-wider-right" style="max-width: 100%">
    <div class="column">
      <img style="box-shadow: 0px 0px 20px 2px rgb(0,0,0,0.05);" src="<?php echo QUADMENU_PLUGIN_URL; ?>assets/backend/images/login.jpg">
    </div>
    <div class="column">
      <div class="feature-section" style="margin: 15px 0;">
  ...
  <div class="has-2-columns is-wider-left" style="max-width: 100%">
    ...
    <div class="column">
      <img style="box-shadow: 0px 0px 20px 2px rgb(0,0,0,0.05);" src="<?php echo QUADMENU_PLUGIN_URL; ?>assets/backend/images/social.jpg">
    </div>
  </div>
  <hr/>
