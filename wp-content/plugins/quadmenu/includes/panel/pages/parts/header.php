<div class="wrap about-wrap full-width-layout qlwrap">
  ...
  <?php printf('<a href="%s" target="_blank"><div style="
               ...
               width: 140px;
               " class="wp-badge">%s</div></a>', 'https://quadlayers.com/?utm_source=quadmenu_admin', plugins_url('/assets/backend/images/quadlayers.jpg', QUADMENU_PLUGIN_FILE), esc_html__('QuadLayers', 'quadmenu')); ?>
